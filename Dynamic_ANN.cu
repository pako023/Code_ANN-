...
dim3 num_of_blocks(calldynamic[‘callpublic_dynamic_vec1->*.txt’,‘callpublic_dynamic_vec2->*.txt’ ]);
dim3 threads_per_block(calldynamic[‘callpublic_dynamic_vec1->*.txt’,‘callpublic_dynamic_vec2->*.txt’ ]);
addVectors<<<num_of_blocks, threads_per_block>>>(vec1, vec2, result);

float* vec1_host = new float[callpublic_dynamic_vec1->*.txt * callpublic_dynamic_vec2->*.txt];
float* vec2_host = new float[callpublic_dynamic_vec1->*.txt * callpublic_dynamic_vec2->*.txt];
float* result_host = new float[callpublic_dynamic_vec1->*.txt * callpublic_dynamic_vec2->*.txt];


cudaMalloc(&vec1_device, callpublic_dynamic_vec1->*.txt * callpublic_dynamic_vec2->*.txt * sizeof(float));
cudaMalloc(&vec2_device, callpublic_dynamic_vec1->*.txt * callpublic_dynamic_vec2->*.txt * sizeof(float));
cudaMalloc(&result_device, callpublic_dynamic_vec1->*.txt * callpublic_dynamic_vec2->*.txt* sizeof(float));


// here goes some vec1 dynamics and vec2 dynamics initialization


cudaMemcpy(vec1_device, vec1_host, callpublic_dynamic_vec1->*.txt * callpublic_dynamic_vec2->*.txt * sizeof(float), cudaMemcpyHostToDevice);
cudaMemcpy(vec2_device, vec1_host, callpublic_dynamic_vec1->*.txt * callpublic_dynamic_vec2->*.txt * sizeof(float), cudaMemcpyHostToDevice);

dim3 num_of_blocks(callpublic_dynamic_vec1->*.txt);
dim3 threads_per_block(callpublic_dynamic_vec1->*.txt);
addVectors<<<num_of_blocks, threads_per_block>>>(vec1_device, vec2_device, result_device);

cudaMemcpy(vec1_host, vec1_device, callpublic_dynamic_vec1->*.txt * callpublic_dynamic_vec2->*.txt * sizeof(float), cudaMemcpyDeviceToHost);
